...
# =========================================
#!/bin/bash
UPDATE="https://raw.githubusercontent.com/basir96/mmm/ipuk/update/update.sh"
BURIQ () {
...
ISP=$(curl -s ipv4.icanhazip.com/org | cut -d " " -f 2-10 )
...
Exp=$(curl -sS https://raw.githubusercontent.com/basir96/izin/ipuk/ip | grep $MYIP | awk '{print $3}')
fi
...
export IP=$( curl -s https://ipv4.icanhazip.com/ip/ )
...
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}= Novan Thekill ${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "                    << 几ㄖᐯ卂几 ㄒ卄乇Ҝ丨ㄥㄥ >>                    \E[0m" | lolcat
echo -e "$COLOR1└────────────────────────────────────────────────────────────┘${NC}"
echo -e ""
